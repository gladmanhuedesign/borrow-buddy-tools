...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border-2 px-3 py-1.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 backdrop-blur-md",
  {
    variants: {
      variant: {
        default:
          "bg-transparent border-primary text-primary-foreground",
        secondary:
          "bg-transparent border-secondary text-secondary-foreground",
        destructive:
          "bg-transparent border-destructive text-destructive-foreground",
